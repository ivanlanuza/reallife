		...
		While ($counter <= $count)
			{
				...
				$_sql_query_write = "INSERT INTO tb_liquidation_info VALUES (" . $newliqid . ", '" . $current_userarea . "', CURRENT_TIMESTAMP(), 'E' ,'" . $_description_info . "', '" . $_purpose_info . "', " . $_amount_info . ", " . $liq_rem_bal . ",'" . $_expensedate_info . "', " . $current_userid . ",'')";				
