    ...
    <BODY>
		...
		<div class="container">
			...
			<div class='row' id='maincontentrequest'>
				<form id="frmMain" name="frmMain" action="AC_request_create_process.php" method="post">
					<br /><br />
	    ...
	    <!-- PHP DATA GENERATOR -->
	    	...
	    	<?php
	    		...
	    		$queryScholars = "SELECT scholar_id,scholar_first_name, scholar_last_name FROM tb_scholar_info where scholar_area = '$currarea' AND scholar_status != 'EXPELLED' AND scholar_status != 'GRADUATED' ORDER BY scholar_last_name ASC, scholar_first_name ASC";
				...
				while ($rowScholars = mysql_fetch_object($resultScholars))
					{
						$options_scholar = $options_scholar . $comma . $rowScholars->scholar_id . ": '" . $rowScholars->scholar_first_name . " " . $rowScholars->scholar_last_name . "'";						
						$comma = ", ";
				...
				$(function () {
		        	...
		        	$('#tblAppendGrid').appendGrid({
		            	...
		            	columns: [
		                    	...
		                    	{ name: 'RecordId', type: 'hidden', value: 1 }
		                	],
								hideButtons: {
									append: true,
									moveUp: true,
